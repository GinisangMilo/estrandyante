...
public class facultyController {
    ...
    private void handleviewaccounts() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("facultyaccsettings.fxml"));
    ...
    private void handlequestionnaires() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("facultyquestionnaire.fxml"));
            Parent root = loader.load();
    ...
    private void handlestudinfo() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("facultystudentinfo.fxml"));
            Parent root = loader.load();
